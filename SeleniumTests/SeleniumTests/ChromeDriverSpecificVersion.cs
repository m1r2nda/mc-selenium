...
{
    public class ChromeDriverSpecificVersion
    {
        ...
        private static readonly string path = Path.GetFullPath(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "..", "..", "Chrome"));
