...
namespace SeleniumTests
{
    ...
    public class FullTest
    {
        ...
        public void MyFullTest()
        {
            ...
            //Соглашаемся с политикой куки
            wait.Until(ExpectedConditions.ElementExists(By.CssSelector(".js-cookie-policy-agree")));
            ...
            var city = By.CssSelector(".js-dlform-wrap input[data-suggeststype^='district']"); //Поле ввода названия города
